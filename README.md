PizzaPanel is a dynamic web-based dashboard for pizza restaurants to manage orders, inventory, and customer data in real-time. This project currently includes:
